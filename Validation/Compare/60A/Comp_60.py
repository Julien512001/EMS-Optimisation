...
# df = pd.read_csv('Validation/Compare/60A/Bz_0.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
# x_FEM = df.iloc[:,0].to_numpy()*1e-3
# Bz_0_FEM = df.iloc[:,1].to_numpy()

# df = pd.read_csv('Validation/Compare/60A/Bx_0.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
...
# df = pd.read_csv('Validation/Compare/60A/Bz_1.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
# x_FEM = df.iloc[:,0].to_numpy()*1e-3
# Bz_1_FEM = df.iloc[:,1].to_numpy() 

# df = pd.read_csv('Validation/Compare/60A/Bx_1.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
...
# df = pd.read_csv('Validation/Compare/60A/Bz_2.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
# x_FEM = df.iloc[:,0].to_numpy()*1e-3
# Bz_2_FEM = df.iloc[:,1].to_numpy()

# df = pd.read_csv('Validation/Compare/60A/Bx_2.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
...
df = pd.read_csv('Validation/Compare/60A/Bz_3.txt', 
                 sep='\t', 
                 comment='%')  # nom des colonnes
x_FEM = df.iloc[:,0].to_numpy()*1e-3
Bz_3_FEM = df.iloc[:,1].to_numpy()

df = pd.read_csv('Validation/Compare/60A/Bx_3.txt', 
                 sep='\t', 
                 comment='%')  # nom des colonnes
...
# df = pd.read_csv('Validation/Compare/60A/Bz_4.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
# x_FEM = df.iloc[:,0].to_numpy()*1e-3
# Bz_4_FEM = df.iloc[:,1].to_numpy()

# df = pd.read_csv('Validation/Compare/60A/Bx_4.txt', 
#                  sep='\t', 
#                  comment='%')  # nom des colonnes
...
df = pd.read_csv('Validation/Compare/60A/champ_B_60.csv')
...
for i in range(1):
    ...
    if fig:
        plt.savefig(f"Validation/Compare/60A/valid60_L{i}.pdf", dpi=300)
